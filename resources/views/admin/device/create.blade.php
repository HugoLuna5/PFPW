                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('saveDevice')}}" method="POST">
                            ...
                            <div class="form-group mt-3">
                                <label for="direction_type">Dirección</label>
                                <select class="form-control" name="direction_type" id="direction_type">
                                    <option disabled value="0">Selecciona una opción</option>
                                    <option value="exist">Usar dirección existente</option>
