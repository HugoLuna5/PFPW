                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('updateDirection')}}" method="POST">
                            ...
                            <input value="{{$direction->id}}" required type="hidden" name="id" id="id">
                            <input value="{{$direction->latitude}}" required type="hidden" name="latitude" id="lat">
                            <input value="{{$direction->longitude}}" required type="hidden" name="longitude" id="long">
                            <input value="{{$direction->direction_complete}}" required type="hidden" name="direction_complete" id="direction_complete">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea id="reference_dir" name="reference_dir" class="form-control"  placeholder="Agregar una referencia">{{$direction->reference_dir}}</textarea>
                            </div>
                            ...
                            <div class="form-group mt-4 d-grid">
                                ...
                                <input type="hidden" id="routeDelete" name="routeDelete" value="{{route('deleteDirection')}}">
                                <button id="actionDelete" onclick="deleteDirection('{{$direction->id}}')" class="btn btn-danger mt-2" type="button">ELIMINAR</button>
                            </div>
...
@section('customJS')
    ...
    <script src="{{asset('/js/direction/update.js')}}"></script>
@endsection
